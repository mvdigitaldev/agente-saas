...
from app.agent.llm.schemas import AgentLLMResponse
    ...
    async def generate_response(
        ...
        """
        try:
            # Prepara argumentos opcionais apenas se tiver tools
            kwargs = {}
            if tools:
                kwargs["tools"] = tools
